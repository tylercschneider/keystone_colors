...
module KeystoneColors
  class SettingsController < ApplicationController
    ...
    def destroy
      ...
      redirect_to keystone_colors.settings_path, notice: "Color settings reset to default."
    end
    ...
    def update
      ...
      if @preference.save
        redirect_to keystone_colors.settings_path, notice: "Color settings updated."
      else
